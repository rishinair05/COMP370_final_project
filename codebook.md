...
This codebook defines the main topic of each post. Assign one primary category to each post based on the text_for_coding field. Use "General news" or "Other" only when a post clearly does not fit the more specific categories.
